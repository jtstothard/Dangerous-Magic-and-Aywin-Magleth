...
- **Physical description:** 6'5", translucent blue scales, glass left eye, scarring on left side, left arm spectral and usually covered
- **Key relationships:** [[Lharamit Pirevin Rhyne]], party members, family in Oreon

## Character Overview

- **Class:** Celestial Warlock (INT-based)
- **Personality traits:** Quiet, precise, analytical, blunt, emotionally composed
- **Notable equipment/companions:** None specified

## Background

- **Origins:** Grew up in Oreon, [[Places/Continents/Jealeon/Regions/Aswesh/index|Aswesh]], worked in family funeral business
- **Goals:** Resolve family tragedy, serve mercenary group, support party
- **Connections to other characters:** Travels with [[Lharamit Pirevin Rhyne]], works with party, maintains professional detachment
...
- **[[Notes/Session 15|Session 15]]**:
  - Used undead-sensing lantern in the Cirrubi Central Bureaucracy archives, helped investigate, and faced a summoned undead threat.
...
- Skilled at lie detection and truth extraction
- Uses magic for both combat and investigation (Eldritch Blast, Thaumaturgy)
- Takes leadership in crisis situations
- Applies mortician skills and analytical mind to evidence
- Key support in party's investigations
